...
const getSearch = e => {
  ...
  return (
    <div className="App">
      ...
      {recipes.map(recipe => ( 
         <Recipe key={recipe.recipe.label} title={recipe.recipe.label} ingredients={recipe.recipe.ingredients} calories={recipe.recipe.calories} image={recipe.recipe.image} digests={recipe.recipe.digest
} />
      ))}
      </div> 
    </div>
